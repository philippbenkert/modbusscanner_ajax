...
void drawStatus() {
    ...
    lv_obj_set_width(statusContainer, TFT_WIDTH);
    lv_obj_set_height(statusContainer, 70); // Platz für beide Zeilen
    lv_obj_align(statusContainer, LV_ALIGN_BOTTOM_MID, 0, 0);
